...
% Clase y página                                         %
%--------------------------------------------------------%
\documentclass[$if(fontsize)$$fontsize$,$endif$$if(handout)$handout,$endif$$for(classoption)$$classoption$$sep$,$endfor$ ignorenonframetext, block=fill]{beamer}
\usetheme[
  $if(metropts)$$for(metropts)$$metropts$$sep$,$endfor$$endif$
...
\includegraphics[height=.8cm,width=.8cm]{../../figuras/fisabior.png}
\end{textblock*}}
