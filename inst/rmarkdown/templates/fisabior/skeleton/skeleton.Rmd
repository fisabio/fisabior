...
```{r echo = T, out.height='2cm', out.width='2cm', fig.align='center', fig.cap = 'Un logo molón'}
root_dir <- getwd()
...
\begin{figure}[h!]
    \centering
    \includegraphics[width = 7cm]{fisabior.png}
