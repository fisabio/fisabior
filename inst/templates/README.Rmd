...
Describe el propósito de este proyecto para que todos puedan saber cómo usar su contenido. En caso de utilizar Git y tener un repositorio remoto (GitHub, Bitbucket o GitLab), este documento será visible al inicio del repositorio.
