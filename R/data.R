#' Mortalidad por IAM en hombres en Aragón (1991-2000)
#'
#' Base de datos que contiene la mortalidad observada y esperada para hombres
#' por IAM en 729 municipios de Aragón entre 1991 y 2001 y la cartografía de la
#' región.
#'
#' @format Un Spatial Polygons Data Frame con 729 filas y siete variables:
#' \describe{
